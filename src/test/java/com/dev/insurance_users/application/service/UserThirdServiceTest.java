...
public class UserThirdServiceTest {
    ...
    public void testFindById() {
        ...
        when(userThirdRepository.findById(id)).thenReturn(expectedUser);

        // Act
        Optional<UserThird> result = Optional.ofNullable(userThirdService.findById(id));
    ...
    public void testFindById_UserDoesNotExist() {
        // Arrange
        Long id = 99L;
        when(userThirdRepository.findById(id)).thenReturn(null);
        // Act
        Optional<UserThird> result = Optional.ofNullable(userThirdService.findById(id));
    ...
    public void testFindByDni_UserExists() {
        ...
        UserThird expectedUser = new UserThird();
        when(userThirdRepository.findByDni(dni)).thenReturn((expectedUser));

        // Act
        Optional<UserThird> result = Optional.ofNullable(userThirdService.findByDni(dni));
    ...
    public void testFindByDni_UserDoesNotExist() {
        ...
        when(userThirdRepository.findByDni(dni)).thenReturn(null);
    ...
    public void testFindByEmail_UserExists() {
        ...
        UserThird expectedUser = new UserThird();
        when(userThirdRepository.findByEmail(email)).thenReturn(expectedUser);

        // Act
        Optional<UserThird> result = Optional.ofNullable(userThirdService.findByEmail(email));
    ...
    public void testFindByEmail_UserDoesNotExist() {
        ...
        when(userThirdRepository.findByEmail(email)).thenReturn(null);
